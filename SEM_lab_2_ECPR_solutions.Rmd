...
3. Quick model diagnostics and results
...
1. Fit a model with all the 6 items welfare support items 
...
inspect(fit_ws_6, "cov.ov") 
# same thing, but calculated from model parameters
inspect(fit_ws_6, "est")$lambda %*% inspect(fit_ws_6, "est")$psi %*% t(inspect(fit_ws_6, "est")$lambda) + inspect(fit_ws_6, "est")$theta
# observed covariance matrix 
lavInspect(fit_ws_6, "sampstat")$cov 
# differences between the two matrices 
lavInspect(fit_ws_6, "sampstat")$cov - inspect(fit_ws_6, "cov.ov")
