...
fit_wc_3_factor_corr <- cfa(model_wc_3_factor_corr,  # model formula
                            data=ess_df              # data frame
  )

summary(fit_wc_3_factor_corr)


anova(fit_wc_2_order, fit_wc_3_factor_corr)


```
Based on the $\chi^2$ difference test, the first-order model without latent factor correlations fits the data better. 
